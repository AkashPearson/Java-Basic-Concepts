...
abstract class Bank{
	 /*abstract method - method does not have body must be
	declare abstract keyword and followed by semicolon*/
...
class Sbi extends Bank{
	...
	public void getLoanInterest() {  //abstract method called and implemented
		...
		System.out.println("SBI is providing 5.5% interest");
	}
...
class Hdfc extends Bank{
	...
	public void getLoanInterest() {
		System.out.println("HDFC is providing 6.5% interest");
